# PHP Authorization and Delayed Capture Example

This example demonstrates authorization and delayed capture payment processing using PHP and the Global Payments SDK.
